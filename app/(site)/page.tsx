          ...
          <section className="z-auto">
            <div className="mx-auto max-w-screen-xl px-4 py-8 text-center lg:px-12 lg:py-16">
              ...
              <div className="mx-auto px-4 text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
                <span className="font-semibold uppercase text-gray-400">Apoio ao Canal</span>
                <div className="mt-8 flex flex-wrap items-center justify-center text-gray-500 sm:justify-between">
                  ...
                  >
                    <div className="flex items-center space-x-2 text-4xl">
                      <HandCoins className="h-8 w-8 rounded-md dark:text-white/70" />
                      <span>Livepix</span>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div className="flex items-center space-x-2 text-4xl">
                      <Twitch className="h-8 w-8 rounded-md dark:text-white/70" />
                      <span>Twitch</span>
                    </div>
                  </a>
                </div>
