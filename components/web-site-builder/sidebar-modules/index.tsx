...
import { LayoutGridIcon, SmartphoneIcon, TabletIcon, ComputerIcon, UserIcon } from "lucide-react";

const SidebarModules = () => {
  return (
    <div className="fixed right-0 z-10 hidden h-full w-14 border-b border-r border-t bg-background sm:static sm:w-auto md:block">
